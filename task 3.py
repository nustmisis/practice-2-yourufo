...
NUMB = input('Введите номер машины: ')

if re.fullmatch(r'[ABCEHKMOPTXYАВКМНОРСТУХ]{3}\d{3}', NUMB): print('Старый формат')
else: 
    if re.fullmatch(r'\d{4}[ABCEHKMOPTXYАВКМНОРСТУХ]{3}', NUMB) is None: print('Не подходит ни под один формат')
    else: print('Новый формат')
